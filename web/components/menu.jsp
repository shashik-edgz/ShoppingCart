			...
			<div class="header-grid">
				<div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<ul>	
                                            ...
                                            out.print("<li><i class='glyphicon glyphicon-user' aria-hidden='true'></i><a href='account.jsp'>"+session.getAttribute("user")+"</a></li>");
    out.print("<li><i class='glyphicon glyphicon-log-out' aria-hidden='true'></i><a href='logout?action=logout' >Logout</a></li>");
    } %>
						...
						<li class="active"><i class="glyphicon glyphicon-book" aria-hidden="true"></i><a href="register.jsp">Register</a></li>
					</ul>
				</div>
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					<h1><a href="index.html">NSBM Shopping <span>Shop anywhere</span></a></h1>
				</div>
